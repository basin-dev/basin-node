...
func (r ApiModifyRequest) WriteRequest(writeRequest WriteRequest) ApiModifyRequest {
	r.writeRequest = &writeRequest
	return r
}

func (r ApiModifyRequest) Execute() (bool, *http.Response, error) {
...
*/
func (a *DefaultApiService) Modify(ctx context.Context) ApiModifyRequest {
	return ApiModifyRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return bool
func (a *DefaultApiService) ModifyExecute(r ApiModifyRequest) (bool, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.Modify")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/modify"
...
func (r ApiRegisterRequest) Execute() (bool, *http.Response, error) {
...
// Execute executes the request
//  @return bool
func (a *DefaultApiService) RegisterExecute(r ApiRegisterRequest) (bool, *http.Response, error) {
	var (
