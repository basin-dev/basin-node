...
func (r ApiNotifyRequest) NotifyRequest(notifyRequest NotifyRequest) ApiNotifyRequest {
	r.notifyRequest = &notifyRequest
	return r
}

func (r ApiNotifyRequest) Execute() (bool, *http.Response, error) {
...
*/
func (a *DefaultApiService) Notify(ctx context.Context) ApiNotifyRequest {
	return ApiNotifyRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return bool
func (a *DefaultApiService) NotifyExecute(r ApiNotifyRequest) (bool, *http.Response, error) {
	var (
